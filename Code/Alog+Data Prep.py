...
c_s_n = int(input("Which size contianer is currently attached:\n1) 150\n2) 180\n3) 225\n4) 300\n5) 350\nEnter '1' if 150 container is attached\nEnter '2' if 180 container is attached...\n"))
if c_s_n == 1:
...
c_n = int(input("Which Container is currently attached:\n1) SS\n2) Zr\nEnter '1' if SS\nEnter '2' if Zr\n"))
if c_n==1:
...
#"E:\Aman_doc\EPP Extrusion Plan for the month of Dec'2019.xls"
#path_month_plan = str(input("Enter Path Extrusion Plan of Month Excel: "))
path_month_plan = "E:\Aman_doc\EPP Extrusion Plan for the month of Dec'2019.xls"
#"E:\Aman_doc\Productwise production capacity.xlsx"
#path_production_capacity = str(input("Enter Path Production Capacity Excel: "))
path_production_capacity = "E:\Aman_doc\Productwise production capacity.xlsx"
...
#Read calendar
df_calendar=pd.read_excel("E:\Aman_doc\calendar.xlsx")
...
plan = pd.DataFrame(columns=["container_size","container","material","dimension","expected production"])
...
output_path = "E:\Production Plan\Month Plan.xlsx"
